...
- (void)viewDidLoad
{
    ...
    _searchBar.placeholder = @"请输入书名、作者等关键词";
    self.tableView.tableHeaderView = _searchBar;
    [super viewDidLoad];
}

- (void) viewWillAppear:(BOOL)animated {
    CGSize searchSize = _searchBar.bounds.size;
...
{
    if ([[segue identifier] isEqualToString:@"ViewBookDetailSegue"]) {
        NSIndexPath *indexPath = [self.tableView indexPathForSelectedRow];
        Book *bookToDisplay = [[self fetchedResultsController] objectAtIndexPath:indexPath];
        BookDetailViewController *bookDetailViewController = [segue destinationViewController];
        bookDetailViewController.bookToDisplay = bookToDisplay;
        bookDetailViewController.managedObjectContext = __managedObjectContext;
    }
    if ([[segue identifier] isEqualToString:@"AddBookSegue"]) {
        ...
        editBookInfoViewController.managedObjectContext = __managedObjectContext;
    }
}
